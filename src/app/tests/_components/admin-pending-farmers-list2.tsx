...
export default function PendingFarmers2() {
	const farmers = [
		{
			name: "Michael Farmer",
	...
	return (
		<div className="container mx-auto space-y-4 bg-green-50 p-4">
			<div className="flex items-center justify-between">
				<div>
					<h1 className="text-2xl font-bold text-green-800">
						Farmers Waiting for Approval
					</h1>
					<p className="text-sm text-green-600">Manage pending farmers</p>
				</div>
				<Sheet>
			...
			<div className="space-y-4">
				{farmers.map((farmer) => (
					<Card
						key={farmer.email}
						className="overflow-hidden border-green-200 bg-white"
					>
						...
						<CardContent className="space-y-4 p-4">
							<div className="space-y-3">
								<div className="flex items-center gap-2">
									...
									<span className="text-sm text-green-800">{farmer.email}</span>
								</div>
								<div className="flex items-center gap-2">
							...
							<div className="space-y-2">
								...
								<div className="relative aspect-[4/3] w-full overflow-hidden rounded-lg bg-green-100">
									<Image
										src={farmer.verificationDocument}
